...
class NumberRadicalElectronsEnum(Enum):
    '0'
    '1'
    '2'
    '3'
...
class IsAromaticEnum(Enum):
    'True'
    'False'

class InRingEnum(Enum):
    'True'
    'False'

class BondStereoEnum(Enum):
    'STEREONONE'
    'STEREOZ'
    'STEREOE'
    'STEREOCIS'
